...
namespace WebAPI.Service
{
    public static class ConvertEdmx
    {
        private static Map<Direction, Func<Edmx, Edmx>> Converters { get; } =
            Map(Tuple<Direction, Func<Edmx, Edmx>>(Directions.XmlToResource, ConvertToResource.Convert),
                Tuple<Direction, Func<Edmx, Edmx>>(Directions.ResourceToXml, ConvertToXml.Convert));
